...
WEAPON_SKILL_POINTS = 2.500; -- Multiplies points earned during weapon unlocking.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 3600;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
